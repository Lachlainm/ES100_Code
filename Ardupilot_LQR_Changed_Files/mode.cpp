...
{  
  ...
  // row 2
    ...
    W_t[3][10] = 0.0f;
    W_t[4][10] = 0.0f;
    W_t[5][10] = 0.56818182f;

    // row 12
    W_t[0][11] = 0.0f; 
    W_t[1][11] = 0.0f;
    W_t[2][11] = 0.25f;
    W_t[3][11] = 1.13636364f;
    W_t[4][11] = 0.0f;
    W_t[5][11] = 0.0f;


    I(Vector3f(0.309f,0.0f,0.0f),
                Vector3f(0.0f,0.309f,0.0f),
                Vector3f(0.0f,0.0f,0.6064f));

    if (!I.inverse(invI)) invI = Matrix3f();

    Rotz45(Vector3f(0.707106781186548f,0.707106781186548f,0.0f),
                Vector3f(-0.707106781186548f,0.707106781186548f,0.0f),
                Vector3f(0.0f,0.0f,1.0f));

    Rotz90(Vector3f(0.0f,-1.0f,0.0f),
                Vector3f(1.0f,0.0f,0.0f),
                Vector3f(0.0f,0.0f,1.0f));
    
    Rotx180(Vector3f(1.0f,0.0f,0.0f),
