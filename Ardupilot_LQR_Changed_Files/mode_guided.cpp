...
bool ModeGuided::init(bool ignore_checks)
{
    ...
    // row 1
    K_HL_ALL[0][0] = g.gain_xp; 
    K_HL_ALL[1][0] = 0.0f;
    K_HL_ALL[2][0] = 0.0f;
    K_HL_ALL[3][0] = 0.0f;
    K_HL_ALL[4][0] = 0.0f;
    K_HL_ALL[5][0] = 0.0f;
    K_HL_ALL[6][0] = g.gain_xd;
    K_HL_ALL[7][0] = 0.0f;
    K_HL_ALL[8][0] = 0.0f;
    K_HL_ALL[9][0] = 0.0f;
    K_HL_ALL[10][0] = 0.0f;
    K_HL_ALL[11][0] = 0.0f;
    K_HL_ALL[12][0] = g.gain_xi;
    K_HL_ALL[13][0] = 0.0f;
    K_HL_ALL[14][0] = 0.0f;
    K_HL_ALL[15][0] = 0.0f;
    K_HL_ALL[16][0] = 0.0f;
    ...
    // row 2
    K_HL_ALL[0][1] = 0.0f; 
    K_HL_ALL[1][1] = g.gain_yp;
    K_HL_ALL[2][1] = 0.0f;
    K_HL_ALL[3][1] = 0.0f;
    K_HL_ALL[4][1] = 0.0f;
    K_HL_ALL[5][1] = 0.0f;
    K_HL_ALL[6][1] = 0.0f;
    K_HL_ALL[7][1] = g.gain_yd;
    K_HL_ALL[8][1] = 0.0f;
    K_HL_ALL[9][1] = 0.0f;
    K_HL_ALL[10][1] = 0.0f;
    K_HL_ALL[11][1] = 0.0f;
    K_HL_ALL[12][1] = 0.0f;
    K_HL_ALL[13][1] = g.gain_yi;
    K_HL_ALL[14][1] = 0.0f;
    K_HL_ALL[15][1] = 0.0f;
    K_HL_ALL[16][1] = 0.0f;
    K_HL_ALL[17][1] = 0.0f;
    ...
    K_HL_ALL[0][2] = 0.0f; 
    K_HL_ALL[1][2] = 0.0f;
    K_HL_ALL[2][2] = g.gain_zp;
    K_HL_ALL[3][2] = 0.0f;
    K_HL_ALL[4][2] = 0.0f;
    K_HL_ALL[5][2] = 0.0f;
    K_HL_ALL[6][2] = 0.0f;
    K_HL_ALL[7][2] = 0.0f;
    K_HL_ALL[8][2] = g.gain_zd;
    K_HL_ALL[9][2] = 0.0f;
    K_HL_ALL[10][2] = 0.0f;
    K_HL_ALL[11][2] = 0.0f;
    K_HL_ALL[12][2] = 0.0f;
    K_HL_ALL[13][2] = 0.0f;
    K_HL_ALL[14][2] = g.gain_zi;
    K_HL_ALL[15][2] = 0.0f;
    K_HL_ALL[16][2] = 0.0f;
    K_HL_ALL[17][2] = 0.0f;
    ...
    K_HL_ALL[1][3] = 0.0f;
    K_HL_ALL[2][3] = 0.0f;
    K_HL_ALL[3][3] = g.gain_rollp;
    K_HL_ALL[4][3] = 0.0f;
    K_HL_ALL[5][3] = 0.0f;
    K_HL_ALL[6][3] = 0.0f;
    K_HL_ALL[7][3] = 0.0f;
    K_HL_ALL[8][3] = 0.0f;
    K_HL_ALL[9][3] = g.gain_rolld;
    K_HL_ALL[10][3] = 0.0f;
    K_HL_ALL[11][3] = 0.0f;
    K_HL_ALL[12][3] = 0.0f;
    K_HL_ALL[13][3] = 0.0f;
    K_HL_ALL[14][3] = 0.0f;
    K_HL_ALL[15][3] = g.gain_rolli;
    K_HL_ALL[16][3] = 0.0f;
    K_HL_ALL[17][3] = 0.0f;
    ...
    K_HL_ALL[2][4] = 0.0f;
    K_HL_ALL[3][4] = 0.0f;
    K_HL_ALL[4][4] = g.gain_pitchp;
    K_HL_ALL[5][4] = 0.0f;
    K_HL_ALL[6][4] = 0.0f;
    K_HL_ALL[7][4] = 0.0f;
    K_HL_ALL[8][4] = 0.0f;
    K_HL_ALL[9][4] = 0.0f;
    K_HL_ALL[10][4] = g.gain_pitchd;
    K_HL_ALL[11][4] = 0.0f;
    K_HL_ALL[12][4] = 0.0f;
    K_HL_ALL[13][4] = 0.0f;
    K_HL_ALL[14][4] = 0.0f;
    K_HL_ALL[15][4] = 0.0f;
    K_HL_ALL[16][4] = g.gain_pitchi;
    K_HL_ALL[17][4] = 0.0f;
    ...
    K_HL_ALL[3][5] = 0.0f;
    K_HL_ALL[4][5] = 0.0f;
    K_HL_ALL[5][5] = g.gain_yawp;
    K_HL_ALL[6][5] = 0.0f;
    K_HL_ALL[7][5] = 0.0f;
    K_HL_ALL[8][5] = 0.0f;
    K_HL_ALL[9][5] = 0.0f;
    K_HL_ALL[10][5] = 0.0f;
    K_HL_ALL[11][5] = g.gain_yawd;
    K_HL_ALL[12][5] = 0.0f;
    K_HL_ALL[13][5] = 0.0f;
    K_HL_ALL[14][5] = 0.0f;
    K_HL_ALL[15][5] = 0.0f;
    K_HL_ALL[16][5] = 0.0f;
    K_HL_ALL[17][5] = g.gain_yawi;
...
void ModeGuided::run()
{
    ...
    case SubMode::Pos:
        ...
        updateDesiredState();
        currState = getStateAHRS();
        allocate_control(false);
        break;
...
void ModeGuided::updateDesiredState(){
    desiredState[0] = guided_pos_target_cm[0]/100;
    desiredState[1] = guided_pos_target_cm[1]/100;
    desiredState[2] = guided_pos_target_cm[2]/100;
    //::printf("Desired Z: %f\n", desiredState[2]);
    desiredState[3] = guided_vel_target_cms[0]/100;
    desiredState[4] = guided_vel_target_cms[1]/100;
    desiredState[5] = guided_vel_target_cms[2]/100;

    //Quaternion desAngQuat = guided_angle_state.attitude_quat;
    //float roll, pitch, yaw;
    //desAngQuat.to_euler(roll, pitch, yaw);
    desiredState[6] = 0.0;
    desiredState[7] = 0.0;
    desiredState[8] = 0.0;
...
VectorN<float, 12> ModeGuided::getStateAHRS() {

    Vector3f position;
    if (!ahrs.get_relative_position_NED_home(position)) return VectorN<float,12>();

    Vector3f vel;
    if (!ahrs.get_velocity_NED(vel)) return VectorN<float, 12>();

    Quaternion quat;
    if (!ahrs.get_quaternion(quat)) return VectorN<float, 12>();
    Vector3f orientation;
    quat.to_euler(orientation.x, orientation.y, orientation.z); 

    Vector3f omega; 
    omega = ahrs.get_gyro();

    Matrix3f tempRBW;
    tempRBW.from_euler(orientation.x, orientation.y, orientation.z);
    if (!tempRBW.inverse(RWB)) ::printf("Inverse failed");
    
    VectorN<float, 12> vec12; 
    ...
    vec12[1] = position.y; 
    vec12[2] = position.z; 
    vec12[3] = orientation.x; 
    vec12[4] = orientation.y; 
    vec12[5] = orientation.z; 
    vec12[6] = vel.x; 
    vec12[7] = vel.y; 
    vec12[8] = vel.z; 
    vec12[9] = omega.x; 
...
VectorN<float, 6> ModeGuided::LQI(void){
    float dt = copter.scheduler.get_last_loop_time_s();

    
    for (int i = 0; i<18; i++){
        if (i < 12) {
            error[i] = desiredState[i] - currState[i]; //normal states (including rates)
        }
        if (i >= 12) error[i] = error[i] + error[i-12] * dt; //integrator
        if (fabsf(error[i]) < 0.0000001) error[i] = 0.0;
    }

    return matrixVectorMultiply<6, 18>(K_HL_ALL, error);
}


VectorN<float, 12> ModeGuided::bodyForce2propForces(const VectorN<float,6>& u){
    Vector3f F(u[0], u[1], u[2]);
    Vector3f M(u[3], u[4], u[5]);

    // rotate into plus configuration from world frame
    F = Rotz45 * RWB * F;
    M = Rotz45 * RWB * M;
    VectorN<float, 6> u_body;
    ...
    return matrixVectorMultiply<12, 6>(W_t, u_body);
}

void ModeGuided::gravityFF(VectorN<float, 6>& u){
    ...
    VectorN<float, 6> gravity_correction = matrixVectorMultiply<6, 12>(B_t, G);
    u = u - gravity_correction;
}   

void ModeGuided::FF_Force(VectorN<float, 6>& u){
    for (int i = 0; i<3; i++){
        u[i] += guided_accel_target_cmss[i]/100;
    }
}

Vector3f ModeGuided::allocateControlLL(const Vector3f& propForce){
    float f = norm<float, float, float>(propForce[0], propForce[1], propForce[2]);

    if(f <= 0.000001f) return Vector3f();
    
    //::printf("Prop Force norm = %f", f);
    double theta = std::atan(-propForce.y/propForce.z);
    double phi = std::asin(-propForce.x/f);
    
    double T = (-propForce.z)/(std::cos(theta)*std::cos(phi));

    double omega; 
    if (T <= 0.00001f) {
        omega = 0;
    } else {
        omega = std::sqrt(T/THRUST_COEFF);
    }

    return Vector3f(omega, theta, phi);
}

void ModeGuided::allocate_control(bool useFF) {
    VectorN<float, 6> control = LQI();

    gravityFF(control);

    if (useFF) FF_Force(control); 

    VectorN<float, 12> prop_forces = bodyForce2propForces(control);
    VectorN<float, 12> allControl;
    for(int i = 0; i < 4; i++) {
        Vector3f prop_force(prop_forces[3*i], prop_forces[3*i + 1], prop_forces[3*i + 2]);
        Vector3f prop_control = allocateControlLL(prop_force);

        for (int j = 0; j<3; j++){
	motors->set_actuator(3*i+j, prop_control[j]);
        }
    }
}
