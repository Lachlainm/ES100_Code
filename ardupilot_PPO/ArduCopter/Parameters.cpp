...
// @User: Advanced
    GSCALAR(gain_xp, "GAIN_XP", 16.92672),

// @Param: GAIN_XD
// @DisplayName: X Derivative Gain
// @Description:  X Derivative Gain
// @User: Advanced
    GSCALAR(gain_xd, "GAIN_XD", 15.0),

// @Param: GAIN_XI
// @DisplayName: X Integral Gain
// @Description:  X Integral Gain
// @User: Advanced
    GSCALAR(gain_xi, "GAIN_XI", 0.0),

// @Param: GAIN_YP
// @DisplayName: Y Proportional Gain
// @Description:  Y Proportional Gain
// @User: Advanced
    GSCALAR(gain_yp, "GAIN_YP", 16.92672),

// @Param: GAIN_YD
// @DisplayName: Y Derivative Gain
// @Description:  Y Derivative Gain
// @User: Advanced
    GSCALAR(gain_yd, "GAIN_YD", 15.0),

// @Param: GAIN_YI
// @DisplayName: Y Integral Gain
// @Description:  Y Integral Gain
// @User: Advanced
    GSCALAR(gain_yi, "GAIN_YI", 0.0),

// @Param: GAIN_ZP
// @DisplayName: Z Proportional Gain
// @Description:  Z Proportional Gain
// @User: Advanced
    GSCALAR(gain_zp, "GAIN_ZP", 30.2426),

// @Param: GAIN_ZD
// @DisplayName: Z Derivative Gain
// @Description:  Z Derivative Gain
// @User: Advanced
    GSCALAR(gain_zd, "GAIN_ZD", 19.4668),

// @Param: GAIN_ZI
// @DisplayName: Z Integral Gain
// @Description:  Z Integral Gain
// @User: Advanced
    GSCALAR(gain_zi, "GAIN_ZI", 0.0),

// @Param: GAIN_ROLLP
// @DisplayName: Roll Proportional Gain
// @Description:  Roll Proportional Gain
// @User: Advanced
    GSCALAR(gain_rollp, "GAIN_ROLLP", 12.695),

// @Param: GAIN_ROLLD
// @DisplayName: Roll Derivative Gain
// @Description:  Roll Derivative Gain
// @User: Advanced
    GSCALAR(gain_rolld, "GAIN_ROLLD", 12.695),

// @Param: GAIN_ROLLI
// @DisplayName: Roll Integral Gain
// @Description:  Roll Integral Gain
// @User: Advanced
    GSCALAR(gain_rolli, "GAIN_ROLLI", 0.0),

// @Param: GAIN_PITCHP
// @DisplayName: Pitch Proportional Gain
// @Description:  Pitch Proportional Gain
// @User: Advanced
    GSCALAR(gain_pitchp, "GAIN_PITCHP", 12.695),

// @Param: GAIN_PITCHD
// @DisplayName: Pitch Derivative Gain
// @Description:  Pitch Derivative Gain
// @User: Advanced
    GSCALAR(gain_pitchd, "GAIN_PITCHD", 12.695),

// @Param: GAIN_PITCHI
// @DisplayName: Pitch Integral Gain
// @Description:  Pitch Integral Gain
// @User: Advanced
    GSCALAR(gain_pitchi, "GAIN_PITCHI", 0.0),

// @Param: GAIN_YAWP
// @DisplayName: Yaw Proportional Gain
// @Description:  Yaw Proportional Gain
// @User: Advanced
    GSCALAR(gain_yawp, "GAIN_YAWP", 10.25),

// @Param: GAIN_YAWD
// @DisplayName: Yaw Derivative Gain
// @Description:  Yaw Derivative Gain
// @User: Advanced
    GSCALAR(gain_yawd, "GAIN_YAWD", 7.09),

// @Param: GAIN_YAWI
// @DisplayName: Yaw Integral Gain
// @Description:  Yaw Integral Gain
// @User: Advanced
    GSCALAR(gain_yawi, "GAIN_YAWI", 0.0),
